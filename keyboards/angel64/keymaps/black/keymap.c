...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI, KC_COMMAND, KC_SPC, KC_SPC, KC_SPC, KC_COMMAND, KC_RALT, KC_COMMAND,KC_RCTL),
    [COMMAND] = LAYOUT(
        ...
        KC_NO, KC_NO,  KC_NO, _______, KC_NO, RGB_MOD, KC_NO,  _______, KC_NO,  _______, KC_NO),
};
