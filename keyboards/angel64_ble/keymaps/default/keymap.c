...
#define KC_SETTING    LT(SETTING, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(\
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_COMMAND, KC_SPC,    KC_SETTING, KC_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_DEL \
  ),
  [COMMAND] = LAYOUT(\
    KC_ESC, KC_F1,  KC_F2,  KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_BSPC , \
         KC_NO, KC_UP, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, \
    KC_NO, KC_LEFT, KC_DOWN, KC_RIGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, BATT_LV, \
